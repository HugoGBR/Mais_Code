            ...
            <div className="h-screen flex items-center justify-center bg-cover w-full">
                <div className="sm:w-full md:w-2/3 lg:w-1/2 md:flex-row sm:flex-col sm:flex bg-cover bg-no-repeat bg-[url('/patern.png')]">
                    <div className="md:w-3/4 flex flex-col justify-center md:rounded-l-lg shadow-lg p-10 bg-[#122F54]">
                        ...
                        <h1 className="text-white my-4 md:my-8 text-center text-2xl md:text-4xl font-semibold">Esqueceu sua senha?</h1>
                        <p className="text-white text-center md:mb-24">Preencha os dados ao lado para solicitar a recuperação de senha.</p>
                    </div>
                        ...
                        <div className="w-full flex flex-col justify-center md:mb-16">
                            ...
                            <form id="loginform">
                                <div className="flex flex-col">
                                    <input type="email" id="email" placeholder="E-mail de acesso:" className="border-b-2 h-10 focus:border-b-2 focus:outline-none focus:border-blue-500" />
                                </div>
