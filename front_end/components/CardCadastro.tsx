    ...
    return (
        <div className="flex flex-col md:gap-3 md:flex md:flex-col lg:flex-row">
            <div className="w-full lg:w-3/5">
                <Card className="p-10 hover:drop-shadow-xl">
                    <form>
...
=======
            ...
            <div className="w-full lg:w-2/5">
                <form onSubmit={handleSearchCPF}>
                    <Card className="p-10 hover:drop-shadow-xl grid grid-cols-2 gap-5">
                        ...
                        <div className="col-span-2 grid grid-cols-2 lg:flex gap-4">
                            <div className="lg:inline-flex items-center">
                                ...
                                />
                                <label htmlFor="pagamento-opcao-1" className="block ml-2 text-sm text-gray-900">
                                    À vista
                                </label>
>>>>>>> Stashed changes
                            </div>
...
=======
                        ...
                        <div className="col-span-2 grid grid-cols-2">
                            ...
                            <h1 className="font-bold col-span-1 text-end">{`R$ ${valor_total.toFixed(2)}`}</h1>
                        </div>
