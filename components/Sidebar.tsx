                ...
                <div className="flex h-screen flex-col col-auto justify-between bg-[#122F54] p-2">
                    <div className="mt-5">
                        ...
                        {menuSuperior.map((item) => (
                            ...
                            <Link href={item.href} className="flex text-lg p-2 font-medium hover:bg-white/10 rounded-lg">
                                <div className="flex items-center">
                    ...
                    <div className="flex-col mb-4">
                            <Link href={'/Rotas/Perfil'} className="flex text-lg p-3 font-medium hover:bg-white/10 rounded-lg">
                                <div className="flex items-center">
                                    <ul>
                        ...
                        <Link href={'app/page.tsx'} className="flex text-lg p-3 font-medium hover:bg-white/10 rounded-lg">
                            <div className="flex items-center">
                                <ul>
                                    <li className="flex items-center">
                                        <User className="mr-4 w-9 h-auto"/>
