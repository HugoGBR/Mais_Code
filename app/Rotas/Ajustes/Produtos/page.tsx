        ...
        <div className="flex flex-col h-screen">
            ...
            <div className="flex justify-center items-center flex-grow">
                <div className="max-w-lg w-full bg-white shadow-xl rounded-md p-8"> {/* Removida a classe text-center do card */}
                    <h2 className="text-2xl font-bold mb-6 text-center">Cadastro Produto</h2> {/* Centralizando apenas o título "Cadastro Produto" */}
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex space-x-4 mb-4 rounded-none">
                            <input
                                type="text"
                                id="valorProduto"
                                name="valorProduto"
